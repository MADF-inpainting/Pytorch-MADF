...
class trainset(torch.utils.data.Dataset):
    def __init__(self, img_root, mask_root, img_transform, mask_transform):
        ...
        #self.paths = glob(os.path.dirname(os.path.abspath(__file__)) + img_root + "/**/*.jpg", recursive=True)
        print(img_root, len(self.paths))
        self.mask_paths = glob(os.path.dirname(os.path.abspath(__file__)) + mask_root + "/*.png")
        #print(mask_root, len(self.mask_paths))
